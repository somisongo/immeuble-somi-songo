-- D'abord vérifier s'il existe déjà des baux
DELETE FROM public.leases WHERE owner_id IS NULL;

-- Créer des baux pour lier les propriétés aux locataires avec le bon owner_id
-- Note: Le trigger set_record_owner() va automatiquement définir owner_id = auth.uid()
-- Nous devons donc faire l'insertion en tant qu'utilisateur authentifié
...
-- Correction manuelle de l'owner_id pour tous les baux
UPDATE public.leases 
SET owner_id = '2064d8d3-120b-4ddd-a2b0-8bc71ef7d00e'
